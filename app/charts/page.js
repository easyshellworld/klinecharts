...
export default function Charts(props) {
	...
	fetch('/currency/kline?com_id='+search+'_usdt&symbol='+search+'&anchor=USDT&time="+last+"&market_id=338&period=1d&timestamp=1674739035146&code=ebc161c4c01e448626c3cc30518009d6&platform=web_pc&v=1.0.0&language=en_US&legal_currency=USD')
	.then( res=>res.json() ) 
	.then( data=>{
	...
	return (
		<><h1>{search}</h1><ChartComponent {...props} data={newdata}></ChartComponent></>
	);
}